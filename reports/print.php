...
<head>
  ...
  <!-- Add Google Font to match main app -->
    ...
    <div class="row mb-5 align-items-end border-bottom pb-4 border-2">
      ...
      <div class="col-4 text-end">
        <div class="no-print mb-3">
          ...
          <a class="btn btn-sm btn-outline-secondary px-3 ms-2" href="<?php echo htmlspecialchars(url('/reports/index.php') . (!empty($_GET) ? ('?' . http_build_query($_GET)) : '')); ?>">Close</a>
        </div>
      ...
      <table class="table table-bordered table-sm align-middle">
        ...
        <tbody>
          ...
          <?php foreach ($assets as $a): ?>
            <?php 
              // Create URL safe status class name
              $statusClass = 'status-' . str_replace(' ', '-', $a['status']);
            ?>
            <tr>
